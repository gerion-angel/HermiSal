...
function insertEventos(data) {
    try {
        for (var i = 0; i < data.length; i++) {
            DownloadFile(data[i].urlImagen, "HermiSalvador", "evento" + data[i].id)
        }
...
function insertParticipantes(data) {
    try {
        for (var i = 0; i < data.length; i++) {
            DownloadFile(data[i].urlImagen, "HermiSalvador", "participante" + data[i].id)
        }
        db.transaction(function (tx) {
            for (var i = 0; i < data.length; i++) {
                var ext = "." + data[i].urlImagen.substr(data[i].urlImagen.lastIndexOf('.') + 1);
...
function insertTematicas(data) {
    try {
        for (var i = 0; i < data.length; i++) {
            DownloadFile(data[i].urlImagen, "HermiSalvador", "tematica" + data[i].id)
        }
        db.transaction(function (tx) {
            for (var i = 0; i < data.length; i++) {
                var ext = "." + data[i].urlImagen.substr(data[i].urlImagen.lastIndexOf('.') + 1);
...
function insertLugares(data) {
    try {
        for (var i = 0; i < data.length; i++) {
            DownloadFile(data[i].urlImagen, "HermiSalvador", "lugar" + data[i].id)
        }
        db.transaction(function (tx) {
            for (var i = 0; i < data.length; i++) {
                var ext = "." + data[i].urlImagen.substr(data[i].urlImagen.lastIndexOf('.') + 1);
...
function insertPatrocinadores(data) {
    try {
        for (var i = 0; i < data.length; i++) {
            DownloadFile(data[i].urlLogotipo, "HermiSalvador", "patrocinador" + data[i].id)
        }
        db.transaction(function (tx) {
            for (var i = 0; i < data.length; i++) {
...
function insertBannersEvento(data) {
    try {
        for (var i = 0; i < data.length; i++) {
            DownloadFile(data[i].urlImagen, "HermiSalvador", "banner" + data[i].id)
        }
        db.transaction(function (tx) {
            for (var i = 0; i < data.length; i++) {
                var ext = "." + data[i].urlImagen.substr(data[i].urlImagen.lastIndexOf('.') + 1);
...
function insertActividades(data) {
    try {
        for (var i = 0; i < data.data.length; i++) {
            DownloadFile(data.data[i].urlImagen, "HermiSalvador", "actividad" + data.data[i].id)
        }
        db.transaction(function (tx) {
            for (var i = 0; i < data.data.length; i++) {
...
function updateActividad(data) {
    try {
        DownloadFile(data.actividad[0].urlImagen, "HermiSalvador", "actividad" + data.actividad[0].id)
...
function updateDetalleEvento(data) {
    try {
        DownloadFile(data[0].urlImagen, "HermiSalvador", "evento" + data[0].id)
        db.transaction(function (tx) {
